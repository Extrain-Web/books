...
export const BRAND_PRIMARY = '#F08418';

/** Accent used alongside the primary — the warm coral used on SALE badges and
 *  sale prices (kept distinct from the orange primary, People-Choice style). */
export const BRAND_SECONDARY = '#F05448';
 ...
 */
export function brandFaviconDataUri(letter = 'B'): string {
    const svg =
