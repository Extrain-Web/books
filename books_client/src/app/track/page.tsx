        ...
        <div className="min-h-[70vh] bg-gray-50 py-8 px-4">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="mb-4">
                    <Link
                        href="/"
                        className="inline-flex items-center gap-2 text-xs font-bold text-gray-600 hover:text-[var(--color-primary)] bg-white px-3.5 py-2 rounded-xl border border-gray-200 shadow-2xs hover:shadow-xs transition-all active:scale-95 cursor-pointer"
                    >
                        <LuArrowLeft size={14} />
                        Back to Home
                    </Link>
