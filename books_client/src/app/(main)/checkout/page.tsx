...
const CheckoutPage = () => {
    ...
    const items = React.useMemo(() => {
        try {
            const sel = JSON.parse(localStorage.getItem('booksriver_selected_cart') || localStorage.getItem('skawsarsunnahmart_selected_cart') || 'null');
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (isAuthenticated) {
                ...
                try {
                    localStorage.removeItem('booksriver_selected_cart');
