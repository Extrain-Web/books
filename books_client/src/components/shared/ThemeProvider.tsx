...
const defaultTheme: ThemeContextType = {
    ...
    seoTitle: 'Books River - Your trusted online marketplace',
    seoDescription: 'Shop quality products at the best prices with Books River, your trusted online marketplace in Bangladesh.',
    currency: 'BDT',
    isLoaded: false,
};
...
export function ThemeProvider({ children }: { children: React.ReactNode }) {
    ...
    useEffect(() => {
        ...
        const storeName = g.storeName || 'Books River';
        const tagline = g.tagline || 'Your trusted online marketplace';
        const seoTitle = s.title || `${storeName} — ${tagline}`;
        const seoDescription = s.description || 'Shop quality products at the best prices with Books River, your trusted online marketplace in Bangladesh.';
