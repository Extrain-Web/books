...
export default function MobileBottomNav() {
    ...
    // Staff (admin/superadmin) go to the admin dashboard; customers to the user dashboard.
    const isStaff = user?.role === 'admin' || user?.role === 'superadmin';
    const accountHref = isAuthenticated ? (isStaff ? '/dashboard/admin' : '/dashboard/user') : '/login';
