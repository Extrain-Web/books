                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="flex flex-col md:flex-row gap-10 items-center">
                        ...
                        <div className="flex-1">
                            ...
                            {/* Nav arrows */}
                            <div className="flex gap-2">
                                <button onClick={prev} className="w-9 h-9 rounded-full bg-white border border-gray-200 flex items-center justify-center text-gray-500 hover:bg-[var(--color-primary)] hover:border-white hover:text-white transition-all cursor-pointer">
                                    <LuChevronLeft size={18} />
                                </button>
                                <button onClick={next} className="w-9 h-9 rounded-full bg-white border border-gray-200 flex items-center justify-center text-gray-500 hover:bg-[var(--color-primary)] hover:border-white hover:text-white transition-all cursor-pointer">
