...
const COUPON_STORAGE_KEY = 'bichitrapoint_applied_coupons';
const LEGACY_COUPON_STORAGE_KEY = 'skawsarsunnahmart_applied_coupon';
...
const PaymentSuccessInner = () => {
    ...
    useEffect(() => {
        ...
        try {
            ...
            localStorage.removeItem(LEGACY_COUPON_STORAGE_KEY);
        } catch {}
    }, [dispatch]);
