        ...
        if (res?.data) {
            setFormData({
                ...
                seo: res.data.seo || {
                    ...
                    description: 'Shop the latest products with amazing deals at Bichitra Point.',
                    googleAnalyticsId: '',
                    facebookPixel: '',
                },
            ...
            <div className="space-y-6">
                ...
                <SettingSection icon={LuSettings} title="Store Information" description="Basic store identity">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <InputField label="Store Name" value={g.storeName || ''} onChange={(e: any) => updateGeneral('storeName', e.target.value)} placeholder="Bichitra Point" />
                ...
                <SettingSection icon={LuGlobe} title="SEO & Marketing" description="Search engine and tracking settings">
                    <InputField label="Meta Title" value={seo.title || ''} onChange={(e: any) => updateSeo('title', e.target.value)} placeholder="Bichitra Point - Your trusted online marketplace" helper="Recommended: 50-60 characters" />
