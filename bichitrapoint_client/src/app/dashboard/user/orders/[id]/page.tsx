        ...
        <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        {canCancel && (
                            <button
                                ...
                                className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-bold border border-red-200 text-red-600 hover:bg-red-50 disabled:opacity-50 transition-all cursor-pointer"
                            >
                                <LuSlash size={15} />
            ...
            {returnModalOpen && (
                <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6">
                    ...
                    />
                    <div className="relative bg-white w-full sm:max-w-lg sm:rounded-2xl rounded-t-2xl shadow-xl max-h-[92vh] flex flex-col overflow-hidden z-10">
                        {/* Header */}
            ...
            {cancelModalOpen && (
                <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fadeIn">
                    <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden border border-gray-100 p-6 text-center animate-scaleUp">
                        ...
                        <p className="text-sm text-gray-500 mb-6 leading-relaxed">
                            Are you sure you want to cancel order <span className="font-bold text-gray-800">{order.orderId || order.orderNumber || orderId}</span>? This action cannot be undone.
                        </p>
                        ...
                        <div className="flex items-center gap-3">
                            <button
                                ...
                                disabled={isCancelling}
                                className="flex-1 py-2.5 px-4 rounded-xl border border-gray-200 text-gray-700 text-sm font-bold hover:bg-gray-50 transition-all cursor-pointer"
                            >
                                No, Keep Order
                            </button>
                            <button
                                ...
                                disabled={isCancelling}
                                className="flex-1 py-2.5 px-4 rounded-xl bg-red-600 hover:bg-red-700 text-white text-sm font-bold shadow-md shadow-red-600/20 disabled:opacity-50 transition-all flex items-center justify-center gap-2 cursor-pointer"
                            >
