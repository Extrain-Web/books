                ...
                <Link href={`/product/${product.slug || product.id}`} className='flex flex-col h-full cursor-pointer'>
                    <div className='flex flex-col h-full'>
                        ...
                        <div className='relative w-full aspect-[4/5] bg-[#f8fafc] overflow-hidden flex items-center justify-center shrink-0'>
                            {/* Discount badge */}
                            {discountPercent > 0 && (
                                <span className='absolute top-2 left-2 z-20 bg-[#0284c7] text-white text-[10px] font-bold px-2 py-0.5 rounded-full shadow-sm'>
                                    -{discountPercent}%
                                </span>
                            )}
...
const LIKED_REVIEWS_KEY = 'bichitrapoint_liked_reviews';
const LIKED_REPLIES_KEY = 'bichitrapoint_liked_replies';
