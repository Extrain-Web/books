...
const SearchAutocomplete: React.FC<SearchAutocompleteProps> = ({
    ...
    return (
        <div ref={rootRef} className="relative w-full min-w-0">
            <div
                className={`flex items-center w-full relative bg-white rounded-full transition-shadow duration-200 focus-within:shadow-[0_0_0_3px_rgba(var(--color-primary-rgb),0.12)] ${
