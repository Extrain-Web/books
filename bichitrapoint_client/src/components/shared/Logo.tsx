 ...
 * dynamic store name (e.g. "Bichitra Point") and tagline from `useTheme()`.
 */
interface LogoProps {
...
const DEFAULT_LOGO_MARK = '/Bichitra-Point-Logo-Colored.png';
const DEFAULT_LOGO_LIGHT = '/Bichitra-Point-Logo.png';
const DEFAULT_LOGO_FULL = '/Bichitra-Point-Logo-Colored.png';
...
const Logo: React.FC<LogoProps> = ({
    ...
    const currentStoreName = storeName || 'Bichitra Point';
