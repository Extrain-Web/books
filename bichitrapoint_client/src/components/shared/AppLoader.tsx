...
export default function AppLoader() {
    ...
    const brandLogo = '/Bichitra-Point-Logo-Colored.png';
            ...
            <div className="flex flex-col items-center justify-center px-6 max-w-sm w-full -mt-8 select-none">
                ...
                <div className="relative w-full max-w-[280px] sm:max-w-[320px] mb-6">
                    ...
                    <div className="w-full h-1.5 bg-slate-100 rounded-full overflow-hidden border border-slate-200/60">
                        {/* Progress Fill */}
                        <div
                            className="h-full bg-gradient-to-r from-[var(--color-primary)] to-[#0284C7] rounded-full transition-all duration-100 ease-out"
                    ...
                    >
                        <div className="relative w-10 h-7 flex items-center justify-center drop-shadow-sm animate-[truckBounce_0.6s_ease-in-out_infinite_alternate]">
                            {/* Delivery Truck SVG matching Bichitra Point brand blue */}
                            <svg
                                viewBox="0 0 48 32"
                                className="w-10 h-7"
                                fill="none"
                            ...
                            >
                                ...
                                <rect x="2" y="4" width="28" height="20" rx="2" fill="#0072BC" />
                                <rect x="4" y="6" width="24" height="16" rx="1" fill="#38BDF8" opacity="0.25" />
                                <line x1="16" y1="4" x2="16" y2="24" stroke="#005A96" strokeWidth="1.5" />
