...
const Header: React.FC = () => {
    ...
    // Fetch all active categories for the search dropdown and menus
        ...
        <>
            ...
            <header
                ...
                style={{
                    ...
                    boxShadow: scrolled
                        ? '0 4px 20px -2px rgba(0,0,0,0.22)'
                        : '0 1px 2px rgba(0,0,0,0.05)',
                }}
            >
                <div className="container mx-auto px-3 sm:px-4">
                    <div className="flex items-center gap-2 sm:gap-3 lg:gap-5 h-[58px] sm:h-[76px]">

                            {/* Logo — always leftmost */}
                            <Link href="/" className="shrink-0 mr-1 sm:mr-2 lg:mr-5" onClick={handleGoHome}>
                                <HeaderLogo />
                            </Link>
                                        ...
                                        <>
                                            ...
                                            <div className="relative shrink-0" ref={searchCatRef}>
                                                <button
                                                    ...
                                                    className="flex items-center gap-1.5 pl-4 pr-3 h-[44px] rounded-l-full text-[13px] font-medium text-gray-600 whitespace-nowrap hover:bg-[var(--color-primary-lightest)] transition-colors"
                                                >
                                                            ...
                                                            >
                                                                {cat.icon && (
                                                                    cat.icon.startsWith('http') || cat.icon.startsWith('/') || cat.icon.startsWith('data:') ? (
                                                                        <img src={cat.icon} alt="" className="w-4 h-4 object-contain rounded shrink-0" />
                                                                    ) : (
...
function HeaderLogo() {
    return (
        <div className="group select-none transition-transform duration-300 group-hover:scale-105" aria-label="Bichitra Point">
            <img
                src="/Bichitra-Point-Logo.png"
                alt="Bichitra Point"
                draggable={false}
                className="h-[32px] sm:h-[40px] md:h-[48px] w-auto object-contain"
            />
        </div>
    );
}
