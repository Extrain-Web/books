...
const NewHomePage: React.FC = () => {
    ...
    const dynamicCategoryRows = useMemo(() => {
        ...
        return [
            { categoryName: 'Past Papers', categorySlug: 'past-papers' },
            { categoryName: 'Cambridge Course Book', categorySlug: 'cambridge-course-book' },
            { categoryName: 'Edexcel Student Book', categorySlug: 'edexcel-student-book' },
            { categoryName: 'Childrens Books', categorySlug: 'childrens-books' },
            { categoryName: 'Story Books', categorySlug: 'story-books' },
        ];
    ...
    useEffect(() => {
        ...
        if (productsReady && categoriesReady) {
            window.dispatchEvent(new CustomEvent('bichitrapoint:dataReady'));
        }
