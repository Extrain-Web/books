        ...
        <div className="space-y-6">
            ...
            >
                        ...
                        <div>
                            ...
                            <div className="mt-3 text-xs text-gray-600 space-y-0.5">
                                ...
                                <p className="flex items-center gap-1.5">
                                    ...
                                    <LuMail size={13} className="text-[#0072BC] shrink-0" /> support@bichitrapoint.com
                                </p>
                                <p className="flex items-center gap-1.5">
                                    <LuGlobe size={13} className="text-[#0072BC] shrink-0" /> www.bichitrapoint.com
                                </p>
                            </div>
                        </div>
                ...
                <div className="text-center text-[12px] text-gray-600 font-medium mt-8 pt-4 border-t border-gray-100">
                    <p>Thank you for doing business with Bichitra Point!</p>
                </div>
            </div>
