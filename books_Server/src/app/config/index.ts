...
export default {
    ...
    database_url: process.env.DATABASE_URL || 'mongodb://localhost:27017/bichitrapoint',

    // Human-readable order id prefix (e.g. BCP-0001). White-label: override via env.
    order_id_prefix: process.env.ORDER_ID_PREFIX || 'BCP',

    jwt: {
        access_secret: process.env.JWT_ACCESS_SECRET || 'bichitrapoint-access-secret',
        refresh_secret: process.env.JWT_REFRESH_SECRET || 'bichitrapoint-refresh-secret',
    ...
    email: {
        ...
        from: process.env.EMAIL_FROM || 'noreply@bichitrapoint.com',
    },
