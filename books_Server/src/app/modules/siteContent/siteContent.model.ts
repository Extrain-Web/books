...
const siteContentSchema = new Schema({
    ...
    // A set of promo banner cards shown right after the "Shop By Category"
    // section (typically two side-by-side, like O-Level / A-Level). Only the
    // image is required; title/subtitle/button are optional live-text overlays.
    collectionBanners: [{
        imageUrl: { type: String, required: true },
        title: { type: String, default: '' },
        subtitle: { type: String, default: '' },
