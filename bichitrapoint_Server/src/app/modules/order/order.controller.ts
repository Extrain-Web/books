...
const OrderController = {
    ...
    updateOrderItems: catchAsync(async (req: Request, res: Response) => {
        const order = await OrderService.updateOrderItems(req.params.id, req.body);
        sendResponse(res, { statusCode: 200, success: true, message: 'Order items updated successfully', data: order });
    }),
